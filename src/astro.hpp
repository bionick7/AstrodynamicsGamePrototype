...
struct Orbit {
    ...
    Orbit();
    Orbit(double semi_major_axis, double eccenetricity, double longuitude_of_periapsis, double mu, timemath::Time epoch, bool is_prograde);
    Orbit(Vector2 pos, Vector2 vel, timemath::Time t, double mu);
    Orbit(OrbitPos pos1, OrbitPos pos2, timemath::Time time_at_pos1, double sma, double mu, bool is_prograde, bool cut_focus);
    ...
    void SampleBounded(double bound1, double bound2, Vector2* buffer, int buffer_size, double offset) const;
