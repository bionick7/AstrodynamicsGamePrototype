...
#define ICON_GROUND_CONNECTION        ICON_EMPTY
#define ICON_THERMAL_CONTROL          ICON_EMPTY
#define ICON_CRYOGENICS_FACILITY      ICON_EMPTY
#define ICON_CLEAN_ROOM               ICON_EMPTY
#define ICON_BIO_MANUFACTURING        ICON_EMPTY
#define ICON_ARMS_MANUFACTURING       ICON_EMPTY
#define ICON_PRECISION_MANUFACTURING  ICON_EMPTY
#define ICON_NUCLEAR_ENRICHMENT       ICON_EMPTY
#define ICON_MILITARY_TRAINING        ICON_EMPTY
